...
{\centering\framebox{\lstinline|tipElementa imeZbirke[dim] = \{element1, element2, element3, ...\}|}\par}\
...
{\centering\framebox{\lstinline|char niz[] = {'a','b','c','d' ..... 'n'}|}}
{\centering\framebox{\lstinline|char niz[] = "abcd....n"|}\par}
...
{\centering\framebox{\underline{tip\_funkcije} \lstinline| imeFunkcije()\{/*telo funkcije*/	return 0;\}|}\par}
